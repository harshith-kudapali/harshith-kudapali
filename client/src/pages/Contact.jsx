      ...
      case 0:
        return (
          <div className="space-y-6">
            ...
            >
              CONTINUE MISSION <span className="ml-2">→</span>
            </motion.button>
          </div>
        );
      case 1:
              ...
              <div className="space-y-5">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@example.com" className="text-blue-400 hover:underline flex items-center group">
                      hello@example.com
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">San Francisco, United States</p>
                  </div>
                </motion.div>
