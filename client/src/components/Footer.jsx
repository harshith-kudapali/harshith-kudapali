    ...
    <footer className="bg-gray-900 text-gray-300 pt-10 pb-6 border-t border-blue-500/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          ...
          {/* About Me */}
          <div>
            <h3 className="text-white text-xl font-semibold mb-4">Harshith Kudapali</h3>
            ...
            <div className="flex items-center mb-2">
              ...
              <Link to="tel:+1234567890" className="hover:text-blue-400 transition-colors">+1 (234) 567-890</Link>
            </div>
            <div className="flex items-center mb-2">
              <Mail size={16} className="mr-2 text-blue-400" />
              <Link to="mailto:hello@harshith.dev" className="hover:text-blue-400 transition-colors">hello@harshith.dev</Link>
            </div>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://linkedin.com/in/harshith-kudapali" target="_blank" rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gray-700 p-2 rounded-full transition-all hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
              </a>
              <a href="https://x.com/harshith_dev" target="_blank" rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gray-700 p-2 rounded-full transition-all hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://instagram.com/harshith.codes" target="_blank" rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gray-700 p-2 rounded-full transition-all hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://dribbble.com/harshith" target="_blank" rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gray-700 p-2 rounded-full transition-all hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://codepen.io/harshith" target="_blank" rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gray-700 p-2 rounded-full transition-all hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://dev.to/harshith" target="_blank" rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gray-700 p-2 rounded-full transition-all hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 flex flex-col md:flex-row items-center text-sm mb-4 md:mb-0">
              ...
              <p className="mr-4">Built with <span className="text-red-500">♥</span> and <Coffee size={14} className="inline text-yellow-600 mx-1" /> in San Francisco</p>
